...
function Processing() {
  ...
  return (
    <main className="processing md:h-dvh w-full grid md:grid-rows-1 grid-cols-1 md:grid-cols-[1.5fr_2fr] bg-white text-black max-md:font-black relative overflow-hidden">
      {/* Texts */}
      <div className="overflow-auto flex justify-start items-center max-md:h-dvh mobile-processing max-md:p-5">
